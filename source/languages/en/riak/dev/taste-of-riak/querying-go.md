---
title: "Taste of Riak: Querying with Go"
project: riak
version: 1.3.1+
document: tutorials
toc: true
audience: beginner
keywords: [developers, client, 2i, search, go, golang]
---

## Go Version Setup

For the Go version, please download the source from GitHub by either
...
The code for this chapter is in `/go/ch02/ch02-schemas-and-indexes.go`. You
may import this code into your favorite editor, or just run it from the
command line using `run02` if you are running on a *nix OS.
